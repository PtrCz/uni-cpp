...
def table_to_cpp_src(table: list, name: str, value_type_name: str) -> str:
    ...
    result = f'inline constexpr std::array<{value_type_name}, {table_size}> {name}{{'
    ...
    **Note:** The generated file has **terrible** formatting. Please use clang-format.
    ...
    Args:
        ...
        extra_contents (str | None): Optional contents to include in the file after the table definitions.
                                     The contents **are** in the namespace.
                                     Defaults to None.
    """
    ...
    header_guard_macro = f'UNI_CPP_IMPL_UNICODE_DATA_DATA_{''.join(c if c.isalpha() else '_' for c in filename.upper())}_HPP'
